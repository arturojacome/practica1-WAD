 ...
 * @author AMJac
 */
@WebServlet(name = "ActualizaCategoria", urlPatterns = {"/ActualizaCategoria"})
public class ActualizaCategoria extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                Logger.getLogger(ActualizaCategoria.class.getName()).log(Level.SEVERE, null, ex);
            }          
